...
void FillArray(int[,] arr)   // arr[0,0]=k1, arr[0,1]=b1, arr[1,0]=k2, arr[1,1]=b2,
{
...
void InterPointArr(int[,] arg)  //// arg[0,0]=k1, arg[0,1]=b1, arg[1,0]=k2, arg[1,1]=b2
{
    ...
    {
        int x = (arg[1,1] - arg[0,1]) / (arg[0,0] - arg[1,0]);
        int y = arg[0,0] * x + arg[0,1];
